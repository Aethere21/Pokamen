...
{
	public partial class AttackEnemy : PositionedObject, IDestroyable, IPoolable
	{
		...
		protected static Microsoft.Xna.Framework.Graphics.Texture2D EnemyAttackTexture;
        ...
        public AttackEnemy(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public AttackEnemy(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public virtual void Destroy()
		{
			...
			if (Used)
			{
				AttackEnemyFactory.MakeUnused(this, false);
			}
		...
		public virtual void PostInitialize ()
		{
			...
			Sprite.Texture = EnemyAttackTexture;
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("AttackEnemyStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/attackenemy/enemyattacktexture.png", ContentManagerName))
				{
					registerUnload = true;
				}
				EnemyAttackTexture = FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/attackenemy/enemyattacktexture.png", ContentManagerName);
			}
		...
		public static void UnloadStaticContent ()
		{
			...
			if (LoadedContentManagers.Count == 0)
			{
				if (EnemyAttackTexture != null)
				{
					EnemyAttackTexture= null;
				}
			}
		}
		...
		public static object GetStaticMember (string memberName)
		{
			switch(memberName)
			{
				case  "EnemyAttackTexture":
					return EnemyAttackTexture;
			}
			return null;
		}
