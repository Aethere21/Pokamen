...
{
	public partial class CursorEntity : PositionedObject, IDestroyable
	{
		...
		protected static Microsoft.Xna.Framework.Graphics.Texture2D CursorTexture;
        ...
        public CursorEntity(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("CursorEntityStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/cursorentity/cursortexture.png", ContentManagerName))
				{
					registerUnload = true;
				}
				CursorTexture = FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/cursorentity/cursortexture.png", ContentManagerName);
			}
