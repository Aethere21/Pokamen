...
{
	public partial class AttackPlayer : PositionedObject, IDestroyable, IPoolable
	{
		...
		protected static Microsoft.Xna.Framework.Graphics.Texture2D PlayerAttackTexture;
        ...
        public AttackPlayer(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public AttackPlayer(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public virtual void PostInitialize ()
		{
			...
			Sprite.Texture = PlayerAttackTexture;
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("AttackPlayerStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/attackplayer/playerattacktexture.png", ContentManagerName))
				{
					registerUnload = true;
				}
				PlayerAttackTexture = FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/attackplayer/playerattacktexture.png", ContentManagerName);
			}
		...
		public static object GetStaticMember (string memberName)
		{
			switch(memberName)
			{
				case  "PlayerAttackTexture":
					return PlayerAttackTexture;
			}
			return null;
		}
