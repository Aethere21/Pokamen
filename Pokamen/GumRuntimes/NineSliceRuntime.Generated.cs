	...
	namespace Pokamen.GumRuntimes
	{
		public partial class NineSliceRuntime : Gum.Wireframe.GraphicalUiElement
		{
				...
				set
				{
					...
					switch(mCurrentVariableState)
					{
						case  VariableState.Default:
							...
							Height = 64;
							Red = 255;
							SourceFile = RenderingLibrary.Content.LoaderManager.Self.Load("Standards\\StandardGraphics\\Red_Center.png", RenderingLibrary.SystemManagers.Default);
							Visible = true;
							Width = 64;
							X = 0;
			...
			public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue)
			{
				...
				switch(firstState)
				{
					case  VariableState.Default:
						...
						if (interpolationValue < 1)
						{
							this.SourceFile = RenderingLibrary.Content.LoaderManager.Self.Load("Standards\\StandardGraphics\\Red_Center.png", RenderingLibrary.SystemManagers.Default);
						}
						if (interpolationValue < 1)
						{
							this.Visible = true;
			...
			public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pokamen.GumRuntimes.NineSliceRuntime.VariableState fromState,Pokamen.GumRuntimes.NineSliceRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing)
			{
