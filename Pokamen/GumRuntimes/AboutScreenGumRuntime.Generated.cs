	...
	{
		public partial class AboutScreenGumRuntime : Gum.Wireframe.GraphicalUiElement
		{
			#region State Enums
			...
			public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pokamen.GumRuntimes.AboutScreenGumRuntime.VariableState fromState,Pokamen.GumRuntimes.AboutScreenGumRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing)
			{
			...
			#endregion
			public AboutScreenGumRuntime (bool fullInstantiation = true)
			{
				if (fullInstantiation)
				{
					Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Screens.First(item => item.Name == "AboutScreenGum");
